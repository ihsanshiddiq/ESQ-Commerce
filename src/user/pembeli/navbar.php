      ...
      <div id="mySidenav" class="sidenav" style="z-index: 10000;">
        ...
        <?php
          if(isset($_SESSION["id_role"])){
            ...
            <a class="nav-link active blacken" aria-current="page" href="../../userlist.php">See All Users</a>
            <a class="nav-link active blacken" aria-current="page" href="../../listbarang.php">See All Items</a>
            <?php
              }
            ...
            <a class="nav-link active blacken" aria-current="page" href="#">Check My Shop Items</a>
            <a class="nav-link active blacken" aria-current="page" href="detail-toko.php">See Profile</a>
            <?php
              }
            } else {
              ?>
